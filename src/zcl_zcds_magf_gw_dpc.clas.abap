class ZCL_ZCDS_MAGF_GW_DPC definition
  public
...
protected section.
  ...
  methods SCARRSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZCDS_MAGF_GW_MPC=>TS_SCARR
    raising
  ...
  methods SCARRSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZCDS_MAGF_GW_MPC=>TT_SCARR
...
CLASS ZCL_ZCDS_MAGF_GW_DPC IMPLEMENTATION.
...
*&* This class has been generated on 14.01.2026 17:34:51 in client 250
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZCDS_MAGF_GW_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA scarrset_create_entity TYPE zcl_zcds_magf_gw_mpc=>ts_scarr.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA scarrset_get_entity TYPE zcl_zcds_magf_gw_mpc=>ts_scarr.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZCDS_MAGF_GW_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA scarrset_get_entityset TYPE zcl_zcds_magf_gw_mpc=>tt_scarr.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA scarrset_update_entity TYPE zcl_zcds_magf_gw_mpc=>ts_scarr.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    TYPES ty_ZCDS_MAGF_M2A2_ENTITY_1 TYPE zcds_magf_m2a2_entity ##NEEDED. " reference for where-used list

    DATA(lv_sadl_xml) =
               |<?xml version="1.0" encoding="utf-16"?>| &
               |<sadl:definition xmlns:sadl="http://sap.com/sap.nw.f.sadl" syntaxVersion="V2" >| &
               | <sadl:dataSource type="CDS" name="ScarrSet" binding="ZCDS_MAGF_M2A2_ENTITY" />| &
               |<sadl:resultSet>| &
               |<sadl:structure name="ScarrSet" dataSource="ScarrSet" maxEditMode="RO" >| &
               | <sadl:query name="EntitySetDefault">| &
               | </sadl:query>| &
               | <sadl:attribute name="CARRID" binding="CARRID" isKey="TRUE" />| &
               | <sadl:attribute name="CONNID" binding="CONNID" isKey="TRUE" />| &
               | <sadl:attribute name="CARRNAME" binding="CARRNAME" isKey="FALSE" />| &
               | <sadl:attribute name="CURRCODE" binding="CURRCODE" isKey="FALSE" />| &
               | <sadl:attribute name="URL" binding="URL" isKey="FALSE" />| &
               | <sadl:attribute name="CITYFROM" binding="CITYFROM" isKey="FALSE" />| &
               | <sadl:attribute name="CITYTO" binding="CITYTO" isKey="FALSE" />| &
               |</sadl:structure>| &
               |</sadl:resultSet>| &
               |</sadl:definition>| .
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20260114203500
               iv_uuid              = 'ZCDS_MAGF_GW'
               io_query_control     = me
